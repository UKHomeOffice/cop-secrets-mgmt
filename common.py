...
global_exclusion_list = ['camunda_aws_access_key_id', 'camunda_aws_secret_access_key', 'cop_ops_sql_clients_aws_access_key_id', 'cop_ops_sql_clients_aws_secret_access_key', 'docker_password', 'docker_username', 'doc_cop_aws_access_key_id', 'doc_cop_aws_secret_access_key','drone_private_token', 'drone_public_token', 'executor_aws_access_key_id', 'executor_aws_secret_access_key', 'nginx_image', 'nginx_tag', 'quay_username', 'quay_password', 'report_aws_access_key_id', 'report_aws_secret_access_key', 'slack_webhook']
