...
global_exclusion_list = ['api_cop_image', 'api_cop_port', 'api_form_aws_access_key_id', 'api_form_aws_secret_access_key', 'camunda_aws_access_key_id', 'camunda_aws_secret_access_key', 'cop_tools_aws_access_key_id', 'cop_tools_aws_secret_access_key', 'db_cop_port', 'db_ref_default_username', 'db_ref_governance_anon_username', 'db_ref_governance_authenticator_username', 'db_ref_governance_owner_username', 'db_ref_governance_readonly_username' , 'db_ref_governance_schema', 'db_ref_governance_service_username', 'db_ref_jdbc_options', 'db_ref_options', 'db_ref_port', 'db_ref_private_gitkey', 'db_ref_private_gitrepo', 'db_ref_reference_anon_username', 'db_ref_reference_authenticator_username', 'db_ref_reference_dbname', 'db_ref_reference_owner_username', 'db_ref_reference_readonly_username', 'db_ref_reference_schema', 'db_ref_reference_service_username', 'doc_cop_aws_access_key_id', 'doc_cop_aws_secret_access_key', 'doc_training_aws_access_key_id', 'doc_training_aws_secret_access_key', 'docker_credentials', 'docker_password', 'docker_username', 'drone_private_token', 'drone_public_token', 'engine_port', 'executor_aws_access_key_id', 'executor_aws_secret_access_key', 'flyway_image', 'flyway_tag', 'formbuilder_aws_access_key_id', 'formbuilder_aws_secret_access_key', 'git_repo_private_giturl', 'git_repo_private_port', 'git_repo_private_url', 'jira_db_host_port', 'jira_db_name', 'jira_db_user', 'log_level_debug', 'log_level_info', 'nginx_image', 'nginx_tag', 'perf_test_aws_access_key_id', 'perf_test_aws_secret_access_key', 'pdf_generator_aws_access_key_id', 'pdf_generator_aws_s3_endpoint', 'pdf_generator_aws_s3_port', 'pdf_generator_aws_s3_region', 'pdf_generator_aws_secret_access_key', 'translation_private_key_path', 'postgres_image', 'postgres_tag', 'protocol_awbs', 'protocol_https', 'protocol_jdbc', 'protocol_postgres', 'quay_password', 'quay_username', 'report_aws_access_key_id', 'report_aws_secret_access_key', 'slack_webhook', 'translation_image', 'translation_keycloak_client_id', 'translation_name', 'translation_port', 'www_image', 'www_keycloak_access_role', 'www_keycloak_client_id', 'www_name', 'www_port', 'www_ref_image', 'www_ref_keycloak_client_id', 'www_ref_name', 'www_ref_port', 'www_ui_version']
