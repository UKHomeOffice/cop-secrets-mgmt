...
global_exclusion_list = ['docker_password', 'docker_username', 'doc_cop_aws_access_key_id', 'doc_cop_aws_secret_access_key','drone_private_token', 'drone_public_token', 'nginx_image', 'nginx_tag', 'quay_username', 'quay_password', 'slack_webhook']
